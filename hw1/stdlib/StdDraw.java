package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.StdDraw.java
 *  Execution:    java stdlib.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code stdlib.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code stdlib.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">stdlib.StdDraw.java</a>
 ...
 *           stdlib.StdDraw.setPenRadius(0.05);
 *           stdlib.StdDraw.setPenColor(stdlib.StdDraw.BLUE);
 *           stdlib.StdDraw.point(0.5, 0.5);
 *           stdlib.StdDraw.setPenColor(stdlib.StdDraw.MAGENTA);
 *           stdlib.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code stdlib.StdDraw.line()} and {@code stdlib.StdDraw.point()}
 *  draw lines and points; the methods {@code stdlib.StdDraw.setPenRadius()}
 *  and {@code stdlib.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code stdlib.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   stdlib.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code stdlib.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code stdlib.StdDraw.setPenColor(stdlib.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code stdlib.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code stdlib.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   stdlib.StdDraw.setFont(font);
 *   stdlib.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code stdlib.StdDraw.clear(stdlib.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   stdlib.StdDraw.setScale(-2, +2);
 *   stdlib.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       stdlib.StdDraw.clear();
 *       stdlib.StdDraw.filledCircle(x, y, 0.05);
 *       stdlib.StdDraw.filledCircle(-x, -y, 0.05);
 *       stdlib.StdDraw.show();
 *       stdlib.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code stdlib.StdDraw.BLACK}, {@code stdlib.StdDraw.BLUE}, {@code stdlib.StdDraw.CYAN},
     * {@code stdlib.StdDraw.DARK_GRAY}, {@code stdlib.StdDraw.GRAY}, {@code stdlib.StdDraw.GREEN},
     * {@code stdlib.StdDraw.LIGHT_GRAY}, {@code stdlib.StdDraw.MAGENTA}, {@code stdlib.StdDraw.ORANGE},
     * {@code stdlib.StdDraw.PINK}, {@code stdlib.StdDraw.RED}, {@code stdlib.StdDraw.WHITE}, and
     * {@code stdlib.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to stdlib.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to stdlib.StdDraw)
        try {
            URL url = stdlib.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
