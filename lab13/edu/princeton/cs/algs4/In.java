 ...
 *  Compilation:  javac edu.princeton.cs.introcs.In.java
 *  Execution:    java edu.princeton.cs.introcs.In   (basic test --- see source for required files)
 *
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from edu.princeton.cs.introcs.In to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from edu.princeton.cs.introcs.In to StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from edu.princeton.cs.introcs.In to StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)edu.princeton.cs.introcs.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from edu.princeton.cs.introcs.In to StdIn */
   ...
   /**
     ...
     * <tt>new edu.princeton.cs.introcs.In(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new edu.princeton.cs.introcs.In(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use 
     * <tt>new edu.princeton.cs.introcs.In(filename)</tt>.{@link #readAllStrings()}
     */
